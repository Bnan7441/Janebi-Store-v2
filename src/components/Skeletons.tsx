...
export function ProductCardSkeleton() {
  return (
    <div className="bg-white dark:bg-gray-900 rounded-3xl border border-gray-100 dark:border-gray-800 p-4 relative flex flex-col h-full shadow-xs transition-colors">
      {/* Image Skeleton */}
      <div className="aspect-square w-full relative overflow-hidden rounded-2xl bg-gray-200 dark:bg-gray-800 animate-pulse mb-4">
        <div className="absolute top-3 right-3 w-12 h-5 bg-gray-300 dark:bg-gray-700 rounded-md"></div>
      </div>
      ...
      <div className="grow flex flex-col justify-between">
        <div className="space-y-2">
          {/* Brand badge */}
          <div className="h-3 bg-gray-200 dark:bg-gray-800 rounded-md w-1/3 animate-pulse"></div>
          {/* Title lines */}
          <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded-md w-full animate-pulse"></div>
          <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded-md w-2/3 animate-pulse"></div>
        </div>

        {/* Rating and Price Skeleton */}
        <div className="mt-4 pt-3 border-t border-gray-100 dark:border-gray-800 flex items-center justify-between">
          <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded-md w-16 animate-pulse"></div>
          <div className="flex flex-col items-end gap-1">
            <div className="h-3 bg-gray-200 dark:bg-gray-800 rounded-md w-12 animate-pulse"></div>
            <div className="h-5 bg-gray-200 dark:bg-gray-800 rounded-md w-20 animate-pulse"></div>
          </div>
        </div>
      </div>

      {/* Button Skeleton */}
      <div className="w-full mt-4 h-10 bg-gray-200 dark:bg-gray-800 rounded-xl animate-pulse"></div>
    </div>
  );
}
...
export function ProductDetailSkeleton() {
  return (
    <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 lg:p-10 shadow-sm border border-gray-100 dark:border-gray-800 space-y-8 animate-pulse">
      {/* Breadcrumb Skeleton */}
      <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded-md w-1/3 mb-6"></div>
      ...
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
        ...
        <div className="w-full lg:w-5/12 space-y-4">
          ...
          <div className="flex gap-3">
            {[1, 2, 3].map(i => (
              <div key={i} className="w-20 h-20 bg-gray-200 dark:bg-gray-800 rounded-2xl shrink-0"></div>
            ))}
          </div>
        </div>
        ...
        <div className="w-full lg:w-7/12 flex flex-col justify-between space-y-6">
          ...
          <div className="flex gap-4 py-4 border-y border-gray-100 dark:border-gray-800">
            <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded-md w-24"></div>
            <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded-md w-24"></div>
          </div>

          <div className="flex flex-col items-end space-y-2">
            <div className="h-4 bg-gray-200 dark:bg-gray-800 rounded-md w-20"></div>
          ...
          <div className="flex gap-4 pt-4">
            <div className="flex-1 h-14 bg-gray-200 dark:bg-gray-800 rounded-xl"></div>
...
export function CategoryCardSkeleton() {
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 p-4 sm:p-5 flex flex-col items-center justify-center animate-pulse">
...
export function BrandCardSkeleton() {
  return (
    <div className="border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 rounded-2xl p-6 flex flex-col items-center justify-center h-28 animate-pulse">
...
export function OrderCardSkeleton() {
  return (
    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden animate-pulse">
      <div className="bg-gray-50 dark:bg-gray-800/50 p-4 sm:p-6 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
...
export function ReviewSkeleton() {
  return (
    <div className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-2xl p-5 sm:p-6 space-y-3 animate-pulse">
