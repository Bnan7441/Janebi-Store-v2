    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-6">
        <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-xs">
          ...
          <h3 className="font-bold text-gray-900 dark:text-gray-100 text-base mb-2">تضمین ۱۰۰٪ اصالت</h3>
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-xs">
          ...
          <h3 className="font-bold text-gray-900 dark:text-gray-100 text-base mb-2">ارسال اکسپرس کشوری</h3>
          <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-xs">
          ...
          <h3 className="font-bold text-gray-900 dark:text-gray-100 text-base mb-2">پشتیبانی ۲۴/۷</h3>
          <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-xs">
          ...
          <h3 className="font-bold text-gray-900 dark:text-gray-100 text-base mb-2">بهترین قیمت بازار</h3>
          <p className="text-xs text-gray-600 dark:text-gray-400 leading-relaxed">
      ...
      {/* Story & Details */}
      <div className="bg-white dark:bg-gray-900 rounded-3xl p-6 sm:p-10 border border-gray-100 dark:border-gray-800 shadow-xs space-y-6">
        <h2 className="text-2xl font-black text-gray-900 dark:text-gray-100">داستان جانبی آرنا</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-4 border-t border-gray-100 dark:border-gray-800">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-bold text-gray-900 dark:text-gray-100 text-sm">ارزیابی و تست دقیق قبل از فروش</h4>
          ...
          <div className="flex items-start gap-3">
            <CheckCircle2 className="h-5 w-5 text-emerald-500 shrink-0 mt-0.5" />
            <div>
              <h4 className="font-bold text-gray-900 dark:text-gray-100 text-sm">مهلت بازگشت ۷ روزه واقعی</h4>
